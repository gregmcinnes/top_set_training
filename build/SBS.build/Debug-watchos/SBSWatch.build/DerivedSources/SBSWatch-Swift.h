...
#ifndef SBSWATCH_SWIFT_H
#define SBSWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SBSWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8SBSWatch19WatchSessionManager")
...
@class WCSession;
@class NSString;
@interface WatchSessionManager (SWIFT_EXTENSION(SBSWatch)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC8SBSWatch19WatchWorkoutManager")
...
@class HKSampleType;
@interface WatchWorkoutManager (SWIFT_EXTENSION(SBSWatch)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface WatchWorkoutManager (SWIFT_EXTENSION(SBSWatch)) <HKWorkoutSessionDelegate>
